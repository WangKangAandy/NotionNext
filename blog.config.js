...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '3cd325e5d45e451bb8e7ac051766d689',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.ai-engineer.top/', // 网站地址
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '万事尽头 终将如意', // 站点描述，被notion中的页面描述覆盖
